...
- **Patron Memento** : Pour sauvegarder l'état complet d'un objet
- **Patron Composite** : Pour créer des commandes composées
- **MVVM avec ICommand** : Utilisé massivement en WPF

---

## ❓ Questions fréquentes

**Q: Pourquoi ne pas juste sauvegarder l'état de l'objet ?**
R: Ça marche pour les petits objets, mais devient inefficace pour les gros. Le patron Commande sauvegarde juste l'action, pas tout l'état.

**Q: Et si j'ai 1000 commandes dans l'historique ?**
R: Vous pouvez limiter l'historique (ex: max 50 commandes) ou utiliser le patron Memento pour compresser.

**Q: Toutes les commandes doivent être annulables ?**
R: Non ! Certaines commandes peuvent avoir un `Annuler()` vide (ex: Sauvegarder un fichier).

---

**Fin du cours ! 🎉**

N'oubliez pas de faire les exercices pour bien comprendre le patron Commande !